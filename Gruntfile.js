module.exports = function(grunt) {
  ...
  concat: {
    ...
    notMiny: {
      src:['js/jquery-1.7.1.js','js/jquery-ui-1.10.4.custom.js', 'js/jquery.iosslider.js','js/jquery.isotope.min.js','js/jquery-css-transform.js','js/jquery-rotate.js','js/browserdetect.js','js/mainactions.js','js/min/gsapi.min.js','js/blurobjs.js','library/scripts/vallenato.js','js/jquery.slickwrap.js', 'js/soilsextension_custom.js'],
